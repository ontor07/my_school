			...
			<div class="left-body">
				<div class="divider">
					...
					<div class="teacher-info-box">
						<div class="row">
							<?php 
							$sql_teacher = $db->link->query("SELECT * FROM `teacher_staff` WHERE `department`='$id'");
							if($sql)
							{
								while($view = $sql_teacher->fetch_assoc())
								{
									?>
									<div class="col-6">
										<div class="teacher_info-single-box">
											<div class="teacher_image">
												<img src="../backend/asset/img/teacher/<?php echo $view['image'];?>" class="img-fluid">
											</div>
												...
												<table class="table table-bordered">
													...
													<tr>
														<td colspan="2" style="text-align:center;">
															<a href="view_teacherinfo.php?id=<?php echo $view['id']; ?>" class="btn btn-outline-success">Details</a>
														</td>
													</tr>
												</table>
											</div>

                            ...
                            else
                            {
                                ...
                                if($sql)
                                {
                                    ...
                                    { 
                                        ...
                                        $path = '../../asset/img/admin/'.$fetch_image['image'];
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-body-main">
                            <div class="form-group row">
                                ...
                                <input required type="text" name="username" value="<?php echo $showdata['user_name']; ?>" class="form-control col-lg-5 col-md-5 col-12" required>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-4 col-md-4 col-12"><b>Email</b></label>
                                <input required type="mail" name="mail" placeholder="ex:example@gmail.com" class="form-control col-lg-5 col-md-5 col-12" required value="<?php echo $showdata['email']; ?>">
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <input required type="password" name="password" class="form-control col-lg-5 col-md-5 col-12" value="<?php echo $showdata['recover_password']; ?>">
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-4 col-md-4 col-12"><b>Confirm Password</b></label>
                                <input required type="password" name="confirm_password" class="form-control col-lg-5 col-md-5 col-12" value="<?php echo $showdata['recover_password']; ?>">
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-4 col-md-4 col-12"><b>Picture</b></label>
                                <input type="file" class="filestyle" name="image">
                                <img src="../../asset/img/admin/<?php echo $showdata['image']; ?>" class="img-fluid" alt="" height="80px" width="80px">
                            </div>
